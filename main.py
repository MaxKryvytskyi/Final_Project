...
from my_class import AddtextsBook, Record, Name, Phone, Birthday, Email, Address 
...
def input_error(func):
    def inner(*argsi,**kwargs): 
        ...
        except IncorrectEmailFormat: return f"Incorrect email format" # new
        except IncorrectNameFormat: return f"Incorrect name format" # new
    return inner
